    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <a href="" className=" text-muted" style={{textDecoration:"none"}}>HUF demat account</a> <br />
        ...
        <div className="col">
          ...
          <a href="" className="text-muted" style={{textDecoration:"none"}}>Status of your complaintst</a> <br />
          <a href="" className="text-muted" style={{textDecoration:"none"}}>Bulletin</a> <br />
          <a href="" className="text-muted" style={{textDecoration:"none"}}>Circularn</a> <br />
        ...
        <div className="col">
          ...
          <a className="text-muted" style={{textDecoration:"none"}} href="">Philosophy</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}} href="">Press & Media</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}} href="">Career</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}} href="">Zerodha Cares(CSR)</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}} href="">Zerodha.tech</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}} href="">Open source</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}} href="">Referral program</a> <br />
        </div>
        <div className="col">
          <p>Quick links</p>
          <a className="text-muted" style={{textDecoration:"none"}}  href="">Upcoming IPOs</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}}  href="">Brokerage charges</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}}  href="">Market holidays</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}}  href="">Economic calendar</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}}  href="">Calculators</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}}  href="">Markets</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}}  href="">Sectors</a> <br />
          <a className="text-muted" style={{textDecoration:"none"}}  href="">Gift Nifty</a> <br />
        </div>
      </div>
